...
export default class Contact extends Component {
  render() {
    return(
      <Row className="contact-form" id="contact-form">
        <h4>Contact Us</h4>
        <img src="https://image.ibb.co/ebWpWk/020_247_mail_email_envelope_love_letter_message_heart_valentine.png" alt="Letter"/>
